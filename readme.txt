...
Yandex Delivery (https://delivery.yandex.ru) and WooCommerce - sync, integration, connection

== Description ==

Integration WooCommerce & Yandex Delivery https://delivery.yandex.ru (for Russia)

Интеграция для приложения Яндекс Доставка (агрегатор служб доставки) и WooCommerce (WordPress)
...
* Трекинг виджет - добавлена инструкция для настроек и отрефакторил код
* Карточный виджет - добавлена инструкция для настроек и отрефакторил код
* Гео виджет - добавлена инструкция для настроек и отрефакторил код

= 0.7.1 =
* Добавлены ссылки на расширенную версию и техподдержку

= 0.7 =
* Альфа версия
* Публикация на wp.org

= 0.5 =
* Первая рабочая версия - MVC
